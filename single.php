    ...
    <div class="container">
        <div class="row align-items-center justify-content-center intro">
            <div class="col-md-12" data-aos="fade-up">
                <div class="post-meta">
                    <span>Posted in <?php the_time("F y, Y"); ?></span>
    ...
    <div id="blog" class="site-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <p class="mb-5"><img src="images/img_1.jpg" alt="" class="img-fluid"></p>
                ...
                <div class="col-md-4 sidebar pl-md-5">
                    <div class="sidebar-box">
                        ...
                        ?>
                        <img src="<?php echo esc_url( get_avatar_url( $user->ID ) ); ?>" alt="Image placeholder"
